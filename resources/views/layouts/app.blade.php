...
<html lang="es">
    ...
    <body>
        <div class="min-h-dvh lg:flex">
            ...
            <nav
                aria-label="Módulos"
                class="fixed inset-x-0 bottom-0 z-10 border-t border-cuero/20 bg-crema pb-[env(safe-area-inset-bottom)] lg:static lg:min-h-dvh lg:w-60 lg:shrink-0 lg:border-t-0 lg:border-r"
            >
