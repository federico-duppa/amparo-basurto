...
- **Adjuntos:** cada documento puede llevar **archivos adjuntos** (la póliza, la oblea de la VTV) para tenerlos a mano en el teléfono. Mismo patrón que los adjuntos de Salud: se aceptan **PDF e imágenes (JPG, PNG, WebP, HEIC) de hasta 10 MB**, elegidos de a uno, que se guardan apenas terminan de subir; se descargan por una URL autenticada que entrega el archivo directo con su nombre y tipo real (lo ajeno responde 404, sin URLs públicas ni navegación fuera de la app). Cualquiera con acceso al auto puede subir y eliminar adjuntos (con confirmación); eliminar el adjunto, su documento o el auto borra también el archivo del almacenamiento.
