...
- **Pista:** ayuda al que está atascado. Primero busca un error que trabe —una reina donde no va, o una cruz a mano sobre una casilla donde en realidad va una reina— y lo resalta en rojo con un cartelito. Si no hay errores, resalta en ocre una casilla donde va la próxima reina. **No la pone por vos:** marca la casilla para que la juegues. El resaltado se va con la próxima acción.
...
- **La pista resuelve el tablero en el momento** (`solveQueens`, en `resources/js/queens.js`, con test de Vitest) y lo cachea mientras sea el mismo puzzle. Prioriza señalar errores por sobre revelar dónde va una reina, y nunca completa la jugada sola: resalta y deja jugar.
